 ...
 */
export function pbkdf2HmacSha256(P: string, S: ArrayBuffer | TypedArray, c: number, dkLen: number): Promise<ArrayBuffer>;
/**
 ...
 */
export function scrypt(P: string, S: ArrayBuffer | TypedArray, N: number, r: number, p: number, dkLen: number): Promise<ArrayBuffer>;
/**
